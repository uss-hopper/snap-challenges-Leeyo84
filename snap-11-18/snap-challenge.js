...
const startsWithE = array.split(' ').filter(array=>array.toLowerCase()[0] !='e').join(' ');
// console.log(newArray[3]);

//const startsWithE = array.filter(array => array.startsWith ('e, E'));
//const startsWithE = array.filter()

console.log(startsWithE);

// function filter(array) {
// 	var filterArray = array.filter(function(word) {
// 		return word.charAt(index) === "e";
//
// 	})
// 	return filterArray;
